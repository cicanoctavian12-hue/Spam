...
async def on_ready():
    ...
    # set presence
    try:
        await bot.change_presence(activity=discord.CustomActivity(name="â›„â€¢ Stumble Hour"))
    except Exception:
        pass
...
class TicketSelectMenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            description=f"Hello, describe us your problem and one of our staffs will come and help you soon! 🤗",
...
async def ticket_command(ctx):
    embed = discord.Embed(
        description="Welcome to our ticket Support! Please only open a ticket if you need Support about ingame problems or Server Problems. ⭐",
