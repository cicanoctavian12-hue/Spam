...
# ---------------- Application Modal (updated to 5 questions) ----------------
class ApplicationModal(discord.ui.Modal, title="Content Creator Application"):
    ...
    # The 5 questions the user requested (these are the only inputs in the modal)
    ...
    why_apply = discord.ui.TextInput(
        label="5. Why do you want to be a Content Creator for Stumble Hour?",
        style=discord.TextStyle.paragraph,
        max_length=500,
        required=True
    )
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        # Build purple embed for staff channel listing the 5 Q/A pairs
        ...
        # persist mapping (so Accept/Reject can find applicant later)
...
class ApplyButtonView(discord.ui.View):
    ...
    # Persistent callback for apply button (custom_id is stable)
...
# ---------------- /cc_apply slash command (button label is required) ----------------
...
async def cc_apply(interaction: discord.Interaction, color: str, channel: discord.TextChannel, button: str):
    ...
    # validate button label length (Discord button labels up to 80 chars; keep safe)
