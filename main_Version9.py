...
# ---------------- /embed command (fixed single definition) ----------------
@tree.command(name="embed", description="Create an embed by providing target channel, color and optional picture. Then reply with the message to use.")
@app_commands.describe(
