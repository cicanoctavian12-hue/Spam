...
class ApplyButtonView(discord.ui.View):
    ...
    # This decorated button provides the persistent callback for the APPLY_BUTTON_CUSTOM_ID.
    # When we send dynamically-labelled buttons we set their custom_id to APPLY_BUTTON_CUSTOM_ID
    # so this callback will handle clicks regardless of the displayed label.
...
# ---------------- /cc_apply slash command (now with mandatory 'button' label option) ----------------
