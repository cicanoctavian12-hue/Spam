...
class ApplicationModal(discord.ui.Modal, title="Content Creator Application"):
    ...
    why_apply = discord.ui.TextInput(label="6. Why do you want to be an Content Creator for Stumble Hour?", style=discord.TextStyle.paragraph, max_length=500, required=True)
